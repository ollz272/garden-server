...
urlpatterns = [
    ...
    path(
        r"api-details/<int:plant_pk>/",
        views.PlantApiInfoView.as_view(),
        name="plant-api-details",
    ),
    path(r"<int:plant_pk>/chart/", views.PlantChartView.as_view(), name="plant-chart"),
    #  path(r"<int:plant_pk>/", ..., name='plant-detail'),
    path(
        r"<int:plant_pk>/sensors/create/",
        views.SensorCreateView.as_view(),
        name="create-sensor",
    ),
    path(
        r"<int:plant_pk>/sensors/update/<int:sensor_pk>/",
